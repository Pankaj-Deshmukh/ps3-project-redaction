...
const UploadPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (selectedFile) {
      ...
      reader.readAsDataURL(selectedFile); // Ensure you're reading the correct file
    } else {
      console.error("Error occured while saving your file in Local Storage"); // Navigate only if no file is selected
    }
  };
